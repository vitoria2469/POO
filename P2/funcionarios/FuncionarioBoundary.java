...
public class FuncionarioBoundary extends Application {
    ...
    public void start(Stage stage) {
        ...
        paneForm.add(new Label("Cargo: "), 0, 5);
        paneForm.add(txtCargo, 1, 5);
        paneForm.add(new Label("Endereco: "), 0, 6);
        paneForm.add(txtEndereco, 1, 6);
        paneForm.add(new Label("Setor: "), 0, 7);
        paneForm.add(txtSetor, 1, 7);
    ...
    public void generateColumns() {
        ...
        TableColumn<Funcionario, String> col4 = new TableColumn<>("Telefone");
        col4.setCellValueFactory(new PropertyValueFactory<Funcionario, String>("telefone"));

        TableColumn<Funcionario, String> col5 = new TableColumn<>("Email");
        col5.setCellValueFactory(new PropertyValueFactory<Funcionario, String>("email"));

        TableColumn<Funcionario, String> col6 = new TableColumn<>("Cargo");
        col6.setCellValueFactory(new PropertyValueFactory<Funcionario, String>("cargo"));

        TableColumn<Funcionario, String> col7 = new TableColumn<>("Endereco");
        col7.setCellValueFactory(new PropertyValueFactory<Funcionario, String>("endereco"));

        TableColumn<Funcionario, String> col8 = new TableColumn<>("Setor");
        col8.setCellValueFactory(new PropertyValueFactory<Funcionario, String>("setor"));
        ...
        TableColumn<Funcionario, Void> col9 = new TableColumn<>("Ações");
