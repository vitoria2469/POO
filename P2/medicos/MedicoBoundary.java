...
public class MedicoBoundary extends Application {
    ...
    public void start(Stage stage) {
        ...
        paneForm.add(new Label("CRM: "), 0, 8);
        paneForm.add(txtCrm, 1, 8);
        ...
        paneForm.add(btnGravar, 0, 9);
        paneForm.add(btnPesquisar, 1, 9);
    ...
    public void generateColumns() {
        ...
        col3.setCellValueFactory(new PropertyValueFactory<Medico, String>("cpf"));
        ...
        TableColumn<Medico, String> col7 = new TableColumn<>("Endereco");
        col7.setCellValueFactory(new PropertyValueFactory<Medico, String>("endereco"));

        TableColumn<Medico, String> col8 = new TableColumn<>("Setor");
        col8.setCellValueFactory(new PropertyValueFactory<Medico, String>("setor"));

        TableColumn<Medico, String> col9 = new TableColumn<>("CRM");
        col9.setCellValueFactory(new PropertyValueFactory<Medico, String>("crm"));
        ...
        TableColumn<Medico, Void> col10 = new TableColumn<>("Ações");
        col10.setCellFactory(callback);
